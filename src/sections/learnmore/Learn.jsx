...
const LearnMoreHero = () => {
  return (
    <ContainerLayout>
      <div className="flex flex-col items-center justify-center space-y-6 border-b border-white/10 py-12 md:py-16">

        <Head className="rounded px-4 py-2 text-center text-2xl font-bold uppercase tracking-[0.15rem] shadow transition duration-200 hover:shadow-xl sm:px-6 sm:text-3xl md:text-4xl md:tracking-[0.2rem]">
          Learn More About Our Journey
        </Head>

        <Head className="text-center text-lg tracking-wider text-primary sm:text-xl md:text-2xl">
          From Media to Technology Infrastructure
        </Head>

        <Paragraph className="max-w-4xl text-center text-sm leading-7 sm:text-base sm:leading-8">
          Local Stream Ghana was built around a simple idea:{" "}
          <strong>
            Africa's digital future requires reliable infrastructure.
          </strong>
