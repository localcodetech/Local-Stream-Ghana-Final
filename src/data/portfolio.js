...
export const fullStackProjects = [
  {
    ...
    description:
      "Admin panel for managing schedules, ad slots, and live stream health across multiple stations.",
  ...
  },
  {
    name: "OTT Mobile App",
    description:
      "Cross-platform streaming app with offline downloads and push notifications for new episodes.",
  ...
  },
  {
    ...
    description:
      "Client-facing portal for booking studio time and outside broadcast vans, with payment integration.",
